...
## Purpose
Define SQLite database schema, connection management, migrations, and atomic task operations for concurrent agent access with cross-project support via a global database.
